...
class Livro {
	private String titulo; // vai ser um atributo publico mesmo? se sim, não precisa de getters e setters
	...
	// getters apenas para os atributos privados da classe
	...
	// setters apenas para os atributos que podem ser modificados futuramente
