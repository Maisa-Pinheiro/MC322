...
public class Emprestimo {
	...
	public boolean bloqueio; // membro pode ou nao fazer renovações(true- pode, false-não pode(possui
								// atraso))
	...
	/* método para mostrar quais livros (o titulo do livro) a pessoa emprestou */
	public void ItensEmprestados() {
		System.out.println("Itens emprestados para o membro " + pessoa.getnome() + ":");
		for (Multimidia livro : itens_empres) {
			if (livro != null) {
				System.out.println("- " + livro.gettipo() + ": " + livro.gettitulo() + " de " + livro.getautor());
			}
		}
	}

	/* implementação para emprestimo de livros */
	...
	/*
	 * implementação para saber quantos itens o usuário tem emprestado em seu nome
	 */
	...
	/* implementação para calcular o atraso do emprestimo */
	public int atraso() {
